...
system_prompt = (
    ...
    "KRİTİK KURALLAR - ASLA ATLAMAAAAA:\n"
    ...
    "6. Cevap 1-2 CÜMLE olsun, uzatma!\n\n"
    "DOĞRU ÖRNEKLER:\n"
    "❓ 'Ayrık Matematik kodu nedir?' → METIN: 'BIL301 | Ayrık Matematik' → CEVAP: 'BIL301'\n"
    "❓ 'Bölüm başkanı kim?' → METIN: 'Bölüm Başkanı: Doç. Dr. Ahmet BABALIK' → CEVAP: 'Doç. Dr. Ahmet BABALIK'\n"
    "❓ 'Staj kaç gün?' → METIN: '60 (30x2) işgününden' → CEVAP: 'Toplam 60 işgünü (30 gün x 2 staj)'\n"
    "❓ 'Dekan kim?' → METIN: bilgi yok → CEVAP: 'Bu bilgiye sahip değilim.'\n\n"
